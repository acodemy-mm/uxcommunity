  ...
  return (
    <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <nav className="flex flex-wrap gap-2 sm:gap-4 mb-6 sm:mb-8 border-b border-slate-700 pb-4">
        ...
        <Link href="/admin/enrollments" className="text-slate-400 hover:text-slate-100 font-medium text-sm sm:text-base py-1">
          Enrollments
        </Link>
        <Link href="/admin/cohorts" className="text-slate-400 hover:text-slate-100 font-medium text-sm sm:text-base py-1">
          Cohorts
        </Link>
      </nav>
