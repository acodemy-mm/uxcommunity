    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4 sm:mb-6">
        ...
        <Link
          ...
          className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-500 font-medium text-sm shrink-0"
        >
          Create user
        </Link>
      </div>
      <p className="text-slate-400 mb-4 sm:mb-6 text-sm sm:text-base">
        Accounts are invite-only. Create users here, change roles, and manage
        course access.
      </p>
