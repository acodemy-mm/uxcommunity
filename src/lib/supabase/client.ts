...
export function createClient() {
  ...
  return createBrowserClient(
    ...
    supabaseKey ||
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJnYmp1dWR1c2ZrZWpkZGFibXRkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIxNjE1NzMsImV4cCI6MjA4NzczNzU3M30.4Vvb400nQmlc9jVG6OTEzKDPyNtw20hB6zphItsWJ4Q"
  );
}
